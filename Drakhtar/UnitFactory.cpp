...
Unit *UnitFactory::newSoldier(Team *team, Box *box, int size) {
  ...
  auto unit = new Battalion(scene_, TextureManager::get(textureName), box,
                            soldierAttack, soldierHealth, soldierSpeed,
                            soldierAttackRange, soldierMoveRange, size);
  team->addUnit(unit);
  return unit;
}
...
Unit *UnitFactory::newArcher(Team *team, Box *box, int size) {
  ...
  auto unit = new Battalion(scene_, TextureManager::get(textureName), box, archerAttack,
                            archerHealth, archerSpeed, archerAttackRange,
                            archerMoveRange, size);
  team->addUnit(unit);
  return unit;
}
...
Unit *UnitFactory::newKnight(Team *team, Box *box, int size) {
  ...
  auto unit = new Battalion(scene_, TextureManager::get(textureName), box, knightAttack,
                            knightHealth, knightSpeed, knightAttackRange,
                            knightMoveRange, size);
  team->addUnit(unit);
  return unit;
}
...
Unit *UnitFactory::newWizard(Team *team, Box *box, int size) {
  ...
  auto unit = new Battalion(scene_, TextureManager::get(textureName), box, wizardAttack,
                            wizardHealth, wizardSpeed, wizardAttackRange,
                            wizardMoveRange, size);
  team->addUnit(unit);
  return unit;
}
...
Unit *UnitFactory::newMonster(Team *team, Box *box, int size) {
  ...
  auto unit = new Battalion(scene_, TextureManager::get(textureName), box,
                            monsterAttack, monsterHealth, monsterSpeed,
                            monsterAttackRange, monsterMoveRange, size);
  team->addUnit(unit);
  return unit;
}
