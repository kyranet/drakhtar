...
TurnBar::TurnBar()
  ...
  visibleUnits[0] =
      new GameObject(TextureManager::get("Portraits-Thassa"),
                     Vector2D<int>(WIN_WIDTH - 432 + 1 * 44, WIN_HEIGHT - 30),
                     Vector2D<int>(30, 30));
  visibleUnits[1] =
      new GameObject(TextureManager::get("Portraits-Archer"),
                     Vector2D<int>(WIN_WIDTH - 432 + 2 * 44, WIN_HEIGHT - 30),
                     Vector2D<int>(30, 30));
  visibleUnits[2] =
      new GameObject(TextureManager::get("Portraits-ArcherEnemy"),
                     Vector2D<int>(WIN_WIDTH - 432 + 3 * 44, WIN_HEIGHT - 30),
                     Vector2D<int>(30, 30));
  visibleUnits[3] =
      new GameObject(TextureManager::get("Portraits-Knight"),
                     Vector2D<int>(WIN_WIDTH - 432 + 4 * 44, WIN_HEIGHT - 30),
                     Vector2D<int>(30, 30));
  visibleUnits[4] =
      new GameObject(TextureManager::get("Portraits-KnightEnemy"),
                     Vector2D<int>(WIN_WIDTH - 432 + 5 * 44, WIN_HEIGHT - 30),
                     Vector2D<int>(30, 30));
  visibleUnits[5] =
      new GameObject(TextureManager::get("Portraits-Mage"),
                     Vector2D<int>(WIN_WIDTH - 432 + 6 * 44, WIN_HEIGHT - 30),
                     Vector2D<int>(30, 30));
  visibleUnits[6] =
      new GameObject(TextureManager::get("Portraits-MageEnemy"),
                     Vector2D<int>(WIN_WIDTH - 432 + 7 * 44, WIN_HEIGHT - 30),
                     Vector2D<int>(30, 30));
  visibleUnits[7] =
      new GameObject(TextureManager::get("Portraits-Narrator"),
                     Vector2D<int>(WIN_WIDTH - 432 + 8 * 44, WIN_HEIGHT - 30),
                     Vector2D<int>(30, 30));
  visibleUnits[8] =
      new GameObject(TextureManager::get("Portraits-SoldierEnemy"),
