    ...
    : window_(nullptr), renderer_(nullptr)
{
	...
	textureManager_->add("Units-Thassa", "../images/Units/Thassa.png", 3, 3, SDL_FLIP_HORIZONTAL)
		->addAnimation("default", { 0, 1 })
		->addAnimation("attack", { 2, 3, 4, 5, 6, 7, 8 });
	...
	textureManager_->add("Units-RedSoldier", "../images/Units/RedSoldier.png", 5, 2)
		->addAnimation("default", { 0, 1 })
		->addAnimation("attack", { 2, 3, 4, 5, 6, 7, 8, 9 });
	textureManager_->add("Units-Sheissa", "../images/Units/Sheissa.png", 3, 3)
		->addAnimation("default", { 0, 1 })
		->addAnimation("attack", { 2, 3, 4, 5, 6, 7, 8 });
	textureManager_->add("Units-Valar", "../images/Units/RedValar.png", 4, 3)
		->addAnimation("default", { 0, 1 })
		->addAnimation("attack", { 2, 3, 4, 5, 6, 7, 8, 9, 10 });
