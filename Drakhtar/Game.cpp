...
Game::Game() : window_(nullptr), renderer_(nullptr) {
  ...
  // Units
  textureManager_->add("Units-BlueArcher", "../images/Units/BlueArcher.png", 2,
                       1, SDL_FLIP_HORIZONTAL);
  textureManager_->add("Units-BlueKnight", "../images/Units/BlueKnight.png", 2,
                       1, SDL_FLIP_HORIZONTAL);
  textureManager_->add("Units-BlueMage", "../images/Units/BlueMage.png", 2, 1,
                       SDL_FLIP_HORIZONTAL);
  textureManager_->add("Units-BlueMonster", "../images/Units/BlueMonster.png",
                       2, 1, SDL_FLIP_HORIZONTAL);
  textureManager_->add("Units-BlueSoldier", "../images/Units/BlueSoldier.png",
                       2, 1, SDL_FLIP_HORIZONTAL);
  ...
  textureManager_->add("Units-RedArcher", "../images/Units/RedArcher.png", 2,
                       1);
  textureManager_->add("Units-RedKnight", "../images/Units/RedKnight.png", 2,
                       1);
  textureManager_->add("Units-RedMage", "../images/Units/RedMage.png", 2, 1);
  textureManager_->add("Units-RedMonster", "../images/Units/RedMonster.png", 2,
                       1);
  textureManager_->add("Units-RedSoldier", "../images/Units/RedSoldier.png", 2,
                       1);
  ...
  textureManager_->add("UI-enemyInRange", "../images/UI/enemyInRange.png", 1,
                       1);
  textureManager_->add("UI-activeUnit", "../images/UI/activeUnitCell.png", 1,
                       1);
  textureManager_->add("UI-dialogueBackground",
                       "../images/UI/dialogueBackground.png", 1, 1);
  textureManager_->add("UI-turnBar", "../images/UI/turnBar.png", 1, 1);

  // Button
  textureManager_->add("Button-Play", "../images/MainMenu/Play_Button.png", 1,
                       1);
  textureManager_->add("Button-Options",
                       "../images/MainMenu/Options_Button.png", 1, 1);
  textureManager_->add("Button-Pause", "../images/Pause/Pause_Button.png", 1,
                       1);
  textureManager_->add("Button-Resume", "../images/Pause/Resume_Button.png", 1,
                       1);
  textureManager_->add("Button-Restart", "../images/Pause/Restart_Button.png",
                       1, 1);
  ...
  // Portraits
  textureManager_->add("Portraits-Archer", "../images/Portraits/Archer.png", 1,
                       1);
  textureManager_->add("Portraits-ArcherEnemy",
                       "../images/Portraits/ArcherEnemy.png", 1, 1);
  // TODO(Javi): Nuke this
  textureManager_->add("Portraits-characterPlaceholder",
                       "../images/Portraits/characterPlaceholder.png", 1, 1);
  textureManager_->add("Portraits-Knight", "../images/Portraits/Knight.png", 1,
                       1);
  textureManager_->add("Portraits-KnightEnemy",
                       "../images/Portraits/KnightEnemy.png", 1, 1);
  textureManager_->add("Portraits-Mage", "../images/Portraits/Mage.png", 1, 1);
  textureManager_->add("Portraits-MageEnemy",
                       "../images/Portraits/MageEnemy.png", 1, 1);
  textureManager_->add("Portraits-Narrator", "../images/Portraits/Narrator.png",
                       1, 1);
  textureManager_->add("Portraits-SoldierEnemy",
                       "../images/Portraits/SoldierEnemy.png", 1, 1);
  textureManager_
      ->add("Portraits-Thassa", "../images/Portraits/Thassa.png", 3, 3)
  ...
  textureManager_->add("Maps-FirstBattle", "../images/Maps/FirstBattle.png", 1,
                       1);
  textureManager_->add("Maps-SecondBattle", "../images/Maps/SecondBattle.png",
                       1, 1);
...
void Game::run() {
  while (!stateMachine->getCurrentState()->getexit()) {
    ...
    while (stateMachine->getCurrentState() == currentState_ &&
           !stateMachine->getCurrentState()->getexit()) {
...
GameStateMachine *Game::getStateMachine() { return stateMachine; }

GameState *Game::currentState() { return getInstance()->currentState_; }
