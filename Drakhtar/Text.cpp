...
Text::Text(Texture* texture, Font* font, vector2d pos, vector2d size, SDL_Color &color, string &text)
// fix nullptr
	: GameObject(texture, pos, size), font_(font), color_(color), texture_(texture)
{
	setText(text);
}
